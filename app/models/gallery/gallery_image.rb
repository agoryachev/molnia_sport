...
class Gallery::GalleryImage < MediaFile
  attr_accessible :file
  belongs_to :gallery_file
  ...
  has_attached_file :file,
                      ...
                      path: "#{FILE_STORAGE['sftp']['path']}/media/galleries:date_to_path/:parent_id/:basename_:style.:extension",
                      url: "#{FILE_STORAGE['sftp']['url']}/media/galleries:date_to_path/:parent_id/:basename_:style.:extension",
                      styles: {
                        _620x380: { geometry: '',
                                  convert_options: '-gravity center -resize "620x380^" -crop "620x380+0+0" +repage'
                        },
                        _115x80:   { geometry: '',
                                    convert_options: '-gravity center -resize "115x80^" -crop "115x80+0+0" +repage'
                        },
                        _90x90:   { geometry: '',
                                    convert_options: '-gravity center -resize "90x90^" -crop "90x90+0+0" +repage'
                        }
                      },
                      default_url: "missing/gallery_:style.jpg"
