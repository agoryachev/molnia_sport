...
class Person::MainImage < MediaFile
  attr_accessible :file
  belongs_to :person, foreign_key: :media_file_id
  ...
  has_attached_file :file,
                    ...
                    path: "#{FILE_STORAGE['sftp']['path']}/media/persons/:parent_id/:basename_:style.:extension",
                    url: "#{FILE_STORAGE['sftp']['url']}/media/persons/:parent_id/:basename_:style.:extension",
                    styles: {
                      _150x150: { geometry: '',
